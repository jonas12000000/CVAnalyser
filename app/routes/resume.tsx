...
export const meta = () => [
  { title: "CVMind | Review" },
  { name: "description", content: "Your CV reviews by ai" },
];
  ...
  return (
    <main className="!pt-0">
      ...
      <div className="flex flex-row w-full max-lg:flex-col-reverse">
        <section className="feedback-section bg-[url('/images/bg-small.svg')] bg-cover h-[100vh] items-center justify-center sticky top-0">
          {imageUrl && resumeUrl && (
